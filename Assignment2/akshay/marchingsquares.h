...
public:
    ...
    void drawIsoLines(float propIsoValue, vec4 propIsoColor, int x_vertices, int y_vertices,
                      ScalarField2 grid, const dvec2 cellSize,
                      std::shared_ptr<inviwo::IndexBufferRAM> indexBufferIsoLines,
